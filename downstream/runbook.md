...
## [3] IN64 -> CIFAR transfer probe（✅ 完成 2026-06-07，best L15 = 73.13%）
...
**实测：32 层 best L15 = 73.13%**（中层峰，L0 41.7%→L15 73.1%→L31 64.9%），胜 iGPT-S native 66.93% (+6.2pp)、低于 CC-iGPT v2 native 79.33%（transfer + resize 域偏移代价）。
