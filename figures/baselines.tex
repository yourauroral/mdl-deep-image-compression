...
\begin{axis}[
    ...
    ymin=2.70, ymax=3.00,
    ytick={2.70,2.75,2.80,2.83,2.85,2.90,2.95},
...
\node[font=\scriptsize, align=center, orange!70!black, yshift=4pt] at (axis cs:Ours, 2.8296) {\textbf{2.83} \textbf{82.95M}};

\end{axis}

% --- 标题 ---
\node[font=\footnotesize\bfseries, anchor=south, yshift=3pt]
    at (current bounding box.north) {CIFAR-10 RGB-bit-exact (CC-iGPT v2 ensemble + TTA = 2.8296)};
