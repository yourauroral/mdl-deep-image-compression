...
%   CC-iGPT (Ours)      3.5217 本工作，IN64 v1 in-training ep5（占位，退火尾段未走，最终待回填）
%
% ！占位说明：3.5217 是 ep5/12 末 val（cosine 退火 ep8-12 尚未启动），非最终数字。
...
% 第5个橘黄柱子（Ours，占位 ep5 val 3.5217）
...
\node[font=\scriptsize, align=center, orange!70!black, yshift=4pt] at (axis cs:Ours, 3.5217) {\textbf{3.52}\,\scriptsize ep5*};
...
\node[font=\scriptsize\itshape, gray!50!black, anchor=north, yshift=-2pt]
    ...
    {* CC-iGPT v1 in-training ep5/12 (cosine anneal tail ep8--12 not yet run); final number TBD};
