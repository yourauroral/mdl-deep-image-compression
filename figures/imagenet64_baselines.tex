...
%   CC-iGPT (Ours)      3.5147 本工作，IN64 v1 in-training ep6（占位，退火尾段未走，最终待回填）
%
% ！占位说明：3.5147 是 ep6/12 末 val（cosine 退火 ep8-12 尚未启动），非最终数字。
...
% 第5个橘黄柱子（Ours，占位 ep6 val 3.5147）
...
\node[font=\scriptsize, align=center, orange!70!black, yshift=4pt] at (axis cs:Ours, 3.5147) {\textbf{3.51}\,\scriptsize ep6*};
...
\node[font=\scriptsize\itshape, gray!50!black, anchor=north, yshift=-2pt]
    ...
    {* CC-iGPT v1 in-training ep6/12 (cosine anneal tail ep8--12 not yet run); final number TBD};
