...
%   CC-iGPT (Ours)      3.53   本工作，IN64 v1 in-training ep4（占位，退火尾段未走，最终待回填）
%
% ！占位说明：3.53 是 ep4/12 末 val（cosine 退火 ep8-12 尚未启动），非最终数字。
...
\node[font=\scriptsize, align=center, orange!70!black, yshift=4pt] at (axis cs:Ours, 3.53) {\textbf{3.53}\,\scriptsize ep4*};
...
\node[font=\scriptsize\itshape, gray!50!black, anchor=north, yshift=-2pt]
    ...
    {* CC-iGPT v1 in-training ep4/12 (cosine anneal tail ep8--12 not yet run); final number TBD};
