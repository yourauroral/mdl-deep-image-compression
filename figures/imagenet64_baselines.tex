...
%   CC-iGPT (Ours)      3.4994 本工作，IN64 v1 in-training ep8（占位，ep9 训练中、退火尾段未走完，最终待回填）
%
% ！占位说明：3.4994 是 ep8/12 末 val（cosine 退火 ep9-12 尚未走完），非最终数字。已低于 SPN 3.52、距目标 3.44 剩 0.0594。
...
% 第5个橘黄柱子（Ours，占位 ep8 val 3.4994）
...
\node[font=\scriptsize, align=center, orange!70!black, yshift=4pt] at (axis cs:Ours, 3.4994) {\textbf{3.50}\,\scriptsize ep8*};
...
\node[font=\scriptsize\itshape, gray!50!black, anchor=north, yshift=-2pt]
    ...
    {* CC-iGPT v1 in-training ep8/12 (cosine anneal tail ep9--12 not yet run); final number TBD};
