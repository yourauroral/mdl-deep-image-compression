...
%   CC-iGPT (formal)    3.4812 本工作，单 best.pth/no-TTA teacher-forced，49,999 张，schema v5 manifest（2026-08-03）
%
...
%   正式 3.4812 仍是 ideal-model teacher-forced NLL，不是 arithmetic payload/file bpd；sequential roundtrip 未执行。
...
% 第5个橘黄柱子（Ours，正式 single checkpoint/no-TTA 3.4812）
...
\node[font=\scriptsize, align=center, orange!70!black, yshift=4pt] at (axis cs:Ours, 3.4812) {\textbf{3.4812}};
...
\node[font=\scriptsize\itshape, gray!50!black, anchor=north, yshift=-2pt]
    ...
    {Formal single model/no-TTA teacher-forced = 3.4812 bpd; historical 3-member ensemble+TTA = 3.4800};
