...
% raw-val 已趋平（ep10->11->12 -0.0022/-0.0036，cosine LR 到底），超 SPN 3.52 约 0.039、距 3.44 约 0.041。
% 主表 ensemble(best+swa+ema)+TTA 数字待评测（预期补不上 0.041 gap，叙事：超 SPN、逼近 Sparse Transformer 3.44）。
