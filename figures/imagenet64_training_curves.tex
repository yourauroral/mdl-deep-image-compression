...
%
% 数据来源: experiments/ccigpt_imagenet64_v1_train.log（截至 ep6/12，2026-06-02）
...
%
% ！进行中：ep7-12 待回填（ep7 训练中）。cosine 退火尾段 ep8-12 未走，3.44 目标待最终判定。
...
\node[font=\scriptsize, orange!80!black, anchor=west]
    at (axis cs:6.15, 3.5147) {ep6 val \textbf{3.5147}};
...
\node[font=\scriptsize, gray!50!black, anchor=north, yshift=-2pt]
    ...
    {\textit{N=32/d=448 $\cdot$ 12ep cosine $\cdot$ warmup 1ep $\cdot$ effective batch 288 $\cdot$ 4-GPU DDP $\cdot$ as of ep6/12 (2026-06-02)}};
