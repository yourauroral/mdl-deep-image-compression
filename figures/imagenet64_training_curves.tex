...
% 历史 ensemble(best+SWA+EMA)+TTA hflip = 3.4800（4卡实测 2026-06-07）；
% 正式 single best/no-TTA teacher-forced = 3.4812（49,999 张，schema v5 manifest）；sequential roundtrip 未执行。
