...
\centering
\includegraphics[width=0.49\textwidth]{CC-iGPT R-only training curves.pdf}\hspace{2mm}%
\includegraphics[width=0.49\textwidth]{ImageNet_trainning_curve.pdf}
...
\begin{center}
\includegraphics[height=0.78\textheight,keepaspectratio]{下游任务线性表征.png}
\end{center}
\end{frame}
