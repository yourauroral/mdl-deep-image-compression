...
\centering
\includegraphics[width=0.72\textwidth]{ImageNet64baseline.pdf}

\vspace{2mm}
{\centering\footnotesize\color{muted}
同款双尺度（coarse 256 $+$ fine 12288 token），4-GPU、12 ep cosine；
ep5/12 val \textbf{3.5217} 已追平 SPN，退火尾段未走，目标 \alert{$<$3.44} 待判定。\par}
\end{frame}
